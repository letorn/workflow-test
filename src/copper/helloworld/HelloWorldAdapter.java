...
/**
 * The external Hello World Adapter. In a more realistic example this would be an external async web service that gives
 * back an TicketID (correlationId) and sends back an answer after some processing time.
 */
public class HelloWorldAdapter
{
    ...
    /**
     * Inside the Workflow we need to access the adapter. in orchestration example we will replace this with Injection
     * by spring, guice or self written.
     * 
     * @return
     */
